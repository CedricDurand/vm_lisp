...
;	(format t "Instruction : ~S~%" (get vm 'LABEL))
;	(if (gethash (cdr exp) (get vm 'LABEL))
;		(format t "Function déjà existante ~%")
		;((equal (gethash (cdr exp) (get vm 'LABEL)) nil) (format t "Mdr : ~%"))
...
;	)
	...
	;(setf (gethash (cdr exp) (get vm 'LABEL)) '001)
;	(write (get vm 'memory))
;)
